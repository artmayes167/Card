...
- (void)drawRect:(CGRect)rect
{
    ...
    if (self.faceUp) {
        UIImage *faceImage = [UIImage imageNamed:[NSString stringWithFormat:@"%@-%@-75.png", self.suit, [self rankAsString]]];
        if (faceImage) {
        ...
        [[UIImage imageNamed:@"back-blue-75-1.png"] drawInRect:self.bounds];
    }
